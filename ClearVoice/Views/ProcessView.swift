...
struct ProcessView: View {
    ...
    var body: some View {
        StepCard(
            title: "Process",
            detail: "ClearVoice is temporarily running in enhancement-only mode: four FFmpeg cleanup passes per file, plus optional DeepFilterNet and Hybrid comparison passes when available."
        ) {
